...
<template>
    ...
    {{numberch}}
        ...
        <mc-table
          :prop="['参数', '说明', '类型', '可选值', '默认值']"
          v-model:value="table.number"
        >
        </mc-table>
    </mc-page>
        
    <mc-page>
        <mc-title :content="'日期选择器'">日期选择器</mc-title>
